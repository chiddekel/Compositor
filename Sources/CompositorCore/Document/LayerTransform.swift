// Portable port of Compositor/Document/LayerTransform.swift (file-map tier:
// "Apple replacement/adaptation: Keep transformation math and serialization;
// replace graphics types/paths as needed"). The transformation math is unchanged
// from the macOS original; the Apple API surface is exchanged: `import CoreGraphics`
// is dropped because CGPoint/CGSize/CGRect/CGFloat/CGAffineTransform are provided by
// Foundation + the portable geometry glue (CompositorGeometry.swift).
//
