// GENERATED by scripts/gen-compositorapp-override.sh from Compositor/CompositorApp.swift — do not edit.
// Changes: #selector(T.m(_:)) -> Selector(("m:")); @main removed. See the script for why.
import SwiftUI
import Sparkle
        ...
        Window("Compositor", id: "editor") {
            ...
            .commands {
                ...
                CommandGroup(replacing: .pasteboard) {
                    ...
                    Button("Cut") {
                        if NSApp.keyWindow?.firstResponder is NSTextView { NSApp.sendAction(Selector(("cut:")), to: nil, from: nil) }
                        else if session.selection != nil, session.canCopyPixels { Task { await session.cutSelection() } }
                        else { NSSound.beep() }
                    }
                        .configuredKeyboardShortcut("x")
                    Button("Copy") {
                        if NSApp.keyWindow?.firstResponder is NSTextView { NSApp.sendAction(Selector(("copy:")), to: nil, from: nil) }
                    ...
                    Button("Paste") {
                        if NSApp.keyWindow?.firstResponder is NSTextView { NSApp.sendAction(Selector(("paste:")), to: nil, from: nil) }
                ...
                CommandGroup(after: .pasteboard) {
                    ...
                    Button("Fill with Foreground Color") {
                        if NSApp.keyWindow?.firstResponder is NSTextView {
                            NSApp.sendAction(Selector(("deleteWordBackward:")), to: nil, from: nil)
                    ...
                    Button("Fill with Background Color") {
                        if NSApp.keyWindow?.firstResponder is NSTextView {
                            NSApp.sendAction(Selector(("deleteToBeginningOfLine:")), to: nil, from: nil)
                ...
                CommandMenu("Select") {
                    ...
                    Button("All") {
                        if NSApp.sendAction(Selector(("selectAll:")), to: nil, from: nil) { return }
